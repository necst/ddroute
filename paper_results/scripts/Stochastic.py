...
#Route the circuit
ts = time.time()
routed_qc = transpile(transpiled_qc, layout_method='dense', routing_method='stochastic', coupling_map=coupling_map, basis_gates=gate_set, optimization_level = 0, seed_transpiler=arg_seed)
te = time.time()
...
print(f'STOCHASTIC,{os.path.basename(sys.argv[1])},{os.path.basename(sys.argv[2])},{num_qubits},{init_depth},{initial_operations},{initial_cx},{final_depth},{final_operations},{final_cx},{swap_count},{sys.argv[3]},{route_time}',end="")